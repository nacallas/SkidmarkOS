...
struct WeeklyRoastCache: Codable {
    ...
    /// Backward-compatible initializer that defaults teamSnapshot to nil
    init(leagueId: String, weekNumber: Int, generatedAt: Date, roasts: [String: String], teamSnapshot: [Team]? = nil) {
